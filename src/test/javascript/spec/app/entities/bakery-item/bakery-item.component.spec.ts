...
import { BakeryItemComponent } from 'app/entities/bakery-item/bakery-item.component';
...
describe('Component Tests', () => {
    describe('BakeryItem Management Component', () => {
        let comp: BakeryItemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BakeryItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bakeryItems[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
